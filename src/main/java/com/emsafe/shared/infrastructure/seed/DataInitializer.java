...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedUsers() {
        List<User> users = List.of(
                ...
                User.builder()
                        ...
                        .role(Role.TECHNICIAN).status(UserStatus.INACTIVE)
    ...
    private void seedDevices() {
        User quantum = userRepository.findByEmail("ops@quantumdyn.com").orElse(null);
        User harbor  = userRepository.findByEmail("facilities@harbormed.com").orElse(null);
        User pharma  = userRepository.findByEmail("safety@globalpharma.com").orElse(null);
    ...
    private void seedWorkOrders() {
        ...
        User maria = userRepository.findByEmail("m.silva@field.emsafe.com").orElse(null);
        User robert = userRepository.findByEmail("r.king@field.emsafe.com").orElse(null);
    ...
    private WorkOrder buildWo(String orderId, WorkOrderType type, WorkOrderStatus status,
                              ...
                              String time, User technician, String techName, String techInitials) {
    ...
    private WorkOrder buildDetailedWo(String orderId, WorkOrderType type, WorkOrderStatus status,
                                       ...
                                       User technician, String priority,
